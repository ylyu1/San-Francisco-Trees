...
- In your projects, create a new and seperate dataset named as 'Reports'. This dataset will only includes our interested information extracted from the public data, which reduce the amount of the data. 
